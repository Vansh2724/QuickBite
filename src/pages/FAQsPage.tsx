...
import food from "../assets/images/pexels-photo-1640774.jpeg";
import frame1 from "../assets/images/message-online-chat-social-text-concept.jpg";
import frame2 from "../assets/images/frequently-asked-questions-solution-concept.jpg";
import frame3 from "../assets/images/people-working-call-center.jpg";
import { IoIosArrowDown } from "react-icons/io";
import "aos/dist/aos.css"; // Impo..t AOS CSS
...
const FaqsPage: React.FC = () => {
  ...
  return (
    <div className="bg-gray-50 text-gray-800">
      ...
      {/* Contact Us Section */}
  <section className="py-12 bg-white text-green-700" id="contact" data-aos="fade-up">
  <div className="container px-2 px-lg-4 pb-4 pt-5 mb-5">
    ...
    <div className="flex flex-col items-center justify-center gap-12">
      <div className="md:w-1/2 mb-4">
        {/* This section is now fully removed */}
      </div>
      <div className="md:w-1/2 text-center">
        <h3 className="text-lg font-semibold mb-2">Get in Touch!</h3>
        <p>
          Got a question or need assistance? Use the details below to reach
          out, and our team will get back to you as quickly as possible. Whether
          it's a query about your order or general information, we're here to
          help make your QuickBite experience smooth and satisfying. Don't
          hesitate—drop us a message today!
        </p>
        <p className="mt-5 mb-2">
          <strong>Location:</strong> UVPCE, Ganpat University
        </p>
        <p className="mt-2 mb-2">
          <strong>Developed By:</strong> Vansh Patel
        </p>
        <p className="mt-2 mb-2">
          <strong>Developed By:</strong> Chirag Senma
        </p>
      </div>
    </div>
  </div>
